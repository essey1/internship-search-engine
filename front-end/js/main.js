...
// ======================================================
// Internship table population (fetch from local JSON file)
// ======================================================
$(document).ready(function() {
    var jsonPath = 'internships.json'; // Make sure this file exists in the same folder

    $.getJSON(jsonPath, function(internships) {
        ...
        console.error('Failed to load internships JSON. Check the file path.');
    });
});
